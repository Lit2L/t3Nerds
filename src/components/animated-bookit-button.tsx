  ...
  return (
    <div className='z-10 flex items-center justify-center'>
      <Link
        href='/pricing'
        className={cn(
          'group flex h-8 w-52 scale-100 items-center rounded-lg border-2 border-black/5 bg-neutral-600 transition-all ease-in hover:scale-95 hover:cursor-pointer hover:border-double hover:border-orange-900 hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800 sm:h-9 sm:w-48'
        )}
      >
        <AnimatedShinyText className='flex items-center justify-center px-3 py-0.5 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400'>
          ...
          <span className='font-heading text-sm md:text-xs'>
            Join the NERDS
          </span>
