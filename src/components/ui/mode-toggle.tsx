  ...
  return (
    <AnimatePresence mode='wait'>
      {isDarkMode ? (
        <IconButton
          key='light-mode'
          className='hover:text-primary-brand overflow-hidden text-dark-900 hover:text-dark-500 dark:text-dark-100 dark:hover:text-dark-200'
          onClick={toggleTheme}
        >
        ...
        <IconButton
          key='dark-mode'
          className='hover:text-primary-brand overflow-hidden text-dark-900 hover:text-dark-500 dark:text-dark-50 dark:hover:text-dark-50'
          onClick={toggleTheme}
        >
